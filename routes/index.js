...
router.post('/api/patern/vehicle/trip',Auth.authAccessToken,function (req, res){
...
// router.post('/api/patern/geofence/detail',Auth.authAccessToken,function(req,res){
//     Geofence.history_detail(req,res)
// })
